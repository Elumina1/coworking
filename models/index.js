...
const priceModel = require('./priceModels')
...
// Цены относятся к типу рабочего места
workTypeModel.hasMany(priceModel, { foreignKey: 'work_type_id', as: 'prices' })
priceModel.belongsTo(workTypeModel, { foreignKey: 'work_type_id', as: 'work_type' })

// Роль относится к пользователю
