...
const mapAreas = [
  { id: 14, shape: 'rect', attrs: { x: 726, y: 1, width: 70, height: 100 }, zone: 'Переговорные', center: { x: 761, y: 51 } },
  { id: 15, shape: 'rect', attrs: { x: 726, y: 200, width: 70, height: 100 }, zone: 'Переговорные', center: { x: 761, y: 250 } },
  { id: 18, shape: 'rect', attrs: { x: 288, y: 1, width: 100, height: 100 }, zone: 'Командные комнаты', center: { x: 338, y: 51 } },
  { id: 21, shape: 'rect', attrs: { x: 288, y: 200, width: 100, height: 100 }, zone: 'Командные комнаты', center: { x: 338, y: 250 } },
  { id: 16, shape: 'rect', attrs: { x: 536, y: 1, width: 100, height: 100 }, zone: 'Командные комнаты', center: { x: 586, y: 51 } },
  { id: 19, shape: 'rect', attrs: { x: 536, y: 200, width: 100, height: 100 }, zone: 'Командные комнаты', center: { x: 586, y: 250 } },
  { id: 17, shape: 'rect', attrs: { x: 412, y: 1, width: 100, height: 100 }, zone: 'Командные комнаты', center: { x: 462, y: 51 } },
  { id: 20, shape: 'rect', attrs: { x: 412, y: 200, width: 100, height: 100 }, zone: 'Командные комнаты', center: { x: 462, y: 250 } },
  { id: 22, shape: 'path', attrs: { d: 'M0 1H230V200H0V1Z' }, zone: 'Зона мероприятий', center: { x: 115, y: 100 } },
  { id: 1, shape: 'rect', attrs: { x: 696, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 726, y: 655 } },
  { id: 2, shape: 'rect', attrs: { x: 618, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 648, y: 655 } },
  { id: 3, shape: 'rect', attrs: { x: 540, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 570, y: 655 } },
  { id: 7, shape: 'rect', attrs: { x: 228, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 258, y: 655 } },
  { id: 9, shape: 'rect', attrs: { x: 72, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 102, y: 655 } },
  { id: 8, shape: 'rect', attrs: { x: 150, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 180, y: 655 } },
  { id: 4, shape: 'rect', attrs: { x: 462, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 492, y: 655 } },
  { id: 5, shape: 'rect', attrs: { x: 306, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 336, y: 655 } },
  { id: 6, shape: 'rect', attrs: { x: 384, y: 635, width: 60, height: 40 }, zone: 'Open Space', center: { x: 414, y: 655 } },
  { id: 10, shape: 'rect', attrs: { x: 501, y: 440, width: 60, height: 40 }, zone: 'Open Space', center: { x: 531, y: 460 } },
  { id: 11, shape: 'rect', attrs: { x: 423, y: 440, width: 60, height: 40 }, zone: 'Open Space', center: { x: 453, y: 460 } },
  { id: 12, shape: 'rect', attrs: { x: 501, y: 499, width: 60, height: 40 }, zone: 'Open Space', center: { x: 531, y: 519 } },
  { id: 13, shape: 'rect', attrs: { x: 423, y: 499, width: 60, height: 40 }, zone: 'Open Space', center: { x: 453, y: 519 } }
]
